...
public class SnapFreezePower extends AbstractEasyPower
{
    public AbstractCreature source;

    public static final String POWER_ID = SoulbinderMod.makeID("SnapFreezePower");
    ...
    public SnapFreezePower(final AbstractCreature owner, int amount) {
    ...
    public AbstractPower makeCopy() {
        return new SnapFreezePower(owner,amount);
    }
}