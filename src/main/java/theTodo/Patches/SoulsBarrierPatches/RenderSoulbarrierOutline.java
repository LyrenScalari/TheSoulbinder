...
public class RenderSoulbarrierOutline {
    ...
    public static void Insert(AbstractCreature __instance, SpriteBatch sb, float x, float y) {
        ...
        if (!Gdx.input.isKeyPressed(36) && SoulsField.SoulBarrier.get(__instance) > 0 && __instance.hbAlpha > 0.0F) {
