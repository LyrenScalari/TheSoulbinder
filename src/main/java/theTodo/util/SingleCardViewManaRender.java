...
public class SingleCardViewManaRender {
    ...
    private static void renderElementHelper(SpriteBatch sb, Texture img, float drawX, float drawY) {
        sb.draw(img, drawX, drawY,
                ...
                0, 0, 0, 125, 150, false, false);

    }

    public static void renderElementCost(AbstractEasyCard card, SpriteBatch sb){
        int[] elementCost;
        ...
        if(!card.isLocked && card.isSeen) {
            ...
            int counter = 0;
            if(Bloodcast == null){
                Bloodcast = ImageMaster.loadImage("soulbindermodResources/images/ui/Bloodcast.png");
                Soulshatter = ImageMaster.loadImage("soulbindermodResources/images/ui/Soulshatter.png");
            }
